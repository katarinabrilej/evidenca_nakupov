...
def dodaj():
    #iz polj pridobimo vpisane podatke        
    ...
    #pridobljene podatke zapišemo v datoteko vprasanja.txt oblike:
    #vprašanje*odgovorA*odgovorB*odgovorC*odgovorD*rešitev
    #kasneje bomo lahko iz te datoteke v datoteki iqkviz.py ustvarili sezname, potrebne za delovanje iq kviza
    with open("vprasanja.txt", "a", encoding = "utf-8") as f:
        print("{}*{}*{}*{}*{}*{}".format(vprasanje, odgovorA, odgovorB, odgovorC, odgovorD, resitev), file = f)
    #pobrišemo polja, da uporabnik lahko vnese novo vprašanje        
...
def naprej():
    #okno s šestimi polji za vnašanje nove naloge (vprašanje, 4 odgovori, rešitev)
    okno.destroy()
    okno2 = tk.Tk()
...
#ustvarimo začetno okno z gumbom za začetek vnašanja vprašanj             
okno = tk.Tk()
